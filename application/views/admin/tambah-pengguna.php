							...
							<form action="" method="post">
								...
								<div class="row g-2 p-3">
									<div class="col-md-12 form-floating">
										<input type="password" name="pass1" id="pass1" class="form-control <?= (form_error('pass1')) ? 'is-invalid' : '' ?>" placeholder="Password">
								...
								<div class="row g-2 p-3">
									<div class="col-md-12 form-floating">
										<input type="password" name="pass2" id="pass2" class="form-control <?= (form_error('pass2')) ? 'is-invalid' : '' ?>" placeholder="Ketik ulang password">
