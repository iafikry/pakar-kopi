							...
							<form action="" method="post">
								<div class="row g-2 p-3">
									<div class="col-md-2 form-floating">
										...
										<label for="floatingInputValue">Kode penyakit</label>
									...
									<div class="col-md-10 form-floating">
										...
										<label for="floatingInputNamaPenyakit">Nama penyakit</label>
								...
								<div class="row g-2 p-3">
									<div class="col-md-12 form-floating">
										...
										<label for="floatingInputKeteranganPenyakit">Keterangan</label>
									</div>
								</div>
								<div class="row p-3">
									<div class="col-md-2">
